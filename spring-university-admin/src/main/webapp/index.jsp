...
<!DOCTYPE html>
<!-- ========================================== -->
<!-- index.jsp - 系统首页（Spring 版本）        -->
<!-- 功能和 Java EE 版完全一样                   -->
<!-- ========================================== -->
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <title>大学行政管理系统 - Spring 版</title>
...
<body>
    <div class="container">
        <header>
            <h1>🎓 大学行政管理系统</h1>
            <p class="subtitle">Spring MVC + Hibernate + Tomcat 版本</p>
        </header>
        ...
        <footer>
            <p>技术栈：Spring 5.3 + Hibernate 5.6 + JPA 2.2 + Tomcat</p>
            <p>对比学习：<a href="${pageContext.request.contextPath}/">Spring 版</a> vs <a href="http://localhost:9080/university-admin/">Java EE 版</a></p>
        </footer>
    </div>
</body>
</html>
